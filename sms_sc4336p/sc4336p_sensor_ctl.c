...
static void sc4336p_1L_linear_1440p20_init(VI_PIPE ViPipe);
static void sc4336p_slave_linear_1440p30_init(VI_PIPE ViPipe);
...
{
	CVI_U8 u8ImgMode = g_pastSC4336P[ViPipe]->u8ImgMode;

	sc4336p_i2c_init(ViPipe);

	if (u8ImgMode == SC4336P_MODE_1440P30) {
		sc4336p_linear_1440p30_init(ViPipe);
	} else if (u8ImgMode == SC4336P_1L_MODE_1440P20) {
		sc4336p_1L_linear_1440p20_init(ViPipe);
	} else if (u8ImgMode == SC4336P_SLAVE_MODE_1440P30) {
		sc4336p_slave_linear_1440p30_init(ViPipe);
	}
...
static void sc4336p_1L_linear_1440p20_init(VI_PIPE ViPipe)
{
	...
	sc4336p_write_register( ViPipe, 0x36e9, 0x80 );
	sc4336p_write_register( ViPipe, 0x37f9, 0x80 );
	sc4336p_write_register( ViPipe, 0x3018, 0x1a );
	sc4336p_write_register( ViPipe, 0x3019, 0x0e );
	sc4336p_write_register( ViPipe, 0x301f, 0x34 );
	sc4336p_write_register( ViPipe, 0x30b8, 0x44 );
	sc4336p_write_register( ViPipe, 0x320c, 0x0b );
	sc4336p_write_register( ViPipe, 0x320d, 0xb8 );
	sc4336p_write_register( ViPipe, 0x320e, 0x05 );		// vts
	sc4336p_write_register( ViPipe, 0x320f, 0xdc );		// vts
	sc4336p_write_register( ViPipe, 0x3253, 0x10 );
	sc4336p_write_register( ViPipe, 0x3301, 0x0a );
	sc4336p_write_register( ViPipe, 0x3302, 0xff );
	sc4336p_write_register( ViPipe, 0x3305, 0x00 );
	...
	sc4336p_write_register( ViPipe, 0x34ab, 0xe0 );
	sc4336p_write_register( ViPipe, 0x34ac, 0x02 );
	sc4336p_write_register( ViPipe, 0x34ad, 0x10 );
	sc4336p_write_register( ViPipe, 0x34f8, 0x1f );
	sc4336p_write_register( ViPipe, 0x34f9, 0x20 );
	sc4336p_write_register( ViPipe, 0x3630, 0xc0 );
	sc4336p_write_register( ViPipe, 0x3631, 0x84 );
	...
	sc4336p_write_register( ViPipe, 0x36b5, 0x0b );
	sc4336p_write_register( ViPipe, 0x36b6, 0x0f );
	sc4336p_write_register( ViPipe, 0x36ea, 0x0a );
	sc4336p_write_register( ViPipe, 0x36eb, 0x05 );
	sc4336p_write_register( ViPipe, 0x36ec, 0x0c );
	sc4336p_write_register( ViPipe, 0x36ed, 0x2a );
	sc4336p_write_register( ViPipe, 0x370f, 0x01 );
	sc4336p_write_register( ViPipe, 0x3722, 0x09 );
	sc4336p_write_register( ViPipe, 0x3724, 0x21 );
	sc4336p_write_register( ViPipe, 0x3771, 0x09 );
	...
	sc4336p_write_register( ViPipe, 0x377a, 0x0f );
	sc4336p_write_register( ViPipe, 0x377b, 0x1f );
	sc4336p_write_register( ViPipe, 0x37fa, 0x0a );
	sc4336p_write_register( ViPipe, 0x37fb, 0x31 );
	sc4336p_write_register( ViPipe, 0x37fc, 0x11 );
	sc4336p_write_register( ViPipe, 0x37fd, 0x16 );
	sc4336p_write_register( ViPipe, 0x3905, 0x8c );
	sc4336p_write_register( ViPipe, 0x391d, 0x02 );
	sc4336p_write_register( ViPipe, 0x391f, 0x49 );
	sc4336p_write_register( ViPipe, 0x3926, 0x21 );
	...
	sc4336p_write_register( ViPipe, 0x4509, 0x28 );
	sc4336p_write_register( ViPipe, 0x450d, 0x32 );
	sc4336p_write_register( ViPipe, 0x4819, 0x0b );
	sc4336p_write_register( ViPipe, 0x481b, 0x06 );
	sc4336p_write_register( ViPipe, 0x481d, 0x18 );
	sc4336p_write_register( ViPipe, 0x481f, 0x05 );
	sc4336p_write_register( ViPipe, 0x4821, 0x0b );
	sc4336p_write_register( ViPipe, 0x4823, 0x06 );
	sc4336p_write_register( ViPipe, 0x4825, 0x05 );
	sc4336p_write_register( ViPipe, 0x4827, 0x05 );
	sc4336p_write_register( ViPipe, 0x4829, 0x0a );
	sc4336p_write_register( ViPipe, 0x5000, 0x06 );
	sc4336p_write_register( ViPipe, 0x5780, 0x76 );
	sc4336p_write_register( ViPipe, 0x5784, 0x10 );
	sc4336p_write_register( ViPipe, 0x5785, 0x04 );
	...
	printf("ViPipe:%d,===SC4336P_1L 1440P 20fps 10bit LINE Init OK!===\n", ViPipe);
}
...
static void sc4336p_slave_linear_1440p30_init(VI_PIPE ViPipe)
{
	...
	sc4336p_write_register(ViPipe, 0x36e9, 0x80);
	sc4336p_write_register(ViPipe, 0x37f9, 0x80);
	sc4336p_write_register(ViPipe, 0x301f, 0x0a);
	sc4336p_write_register(ViPipe, 0x30b8, 0x44);
	sc4336p_write_register(ViPipe, 0x3222, 0x01);
	sc4336p_write_register(ViPipe, 0x3253, 0x10);
	sc4336p_write_register(ViPipe, 0x3301, 0x0a);
	sc4336p_write_register(ViPipe, 0x3302, 0xff);
	sc4336p_write_register(ViPipe, 0x3305, 0x00);
	...
	printf("ViPipe:%d,===SC4336P_SLAVE 1440P 30fps 10bit LINE Init OK!===\n", ViPipe);
}
