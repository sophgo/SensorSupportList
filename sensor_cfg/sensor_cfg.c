...
CVI_S32 cvi_sns_getsize(CVI_U32 dev_num, SENSOR_CFG_S *sensor_cfg)
{
	...
	case SMS_SC202CS_1L_SLAVE_MIPI_320P_30FPS_10BIT:
	case SMS_SC202CS_1L_MASTER_MIPI_320P_30FPS_10BIT:
		sns_cfg->u32ImageWigth[dev_num] = 512;
		sns_cfg->u32ImageHeight[dev_num] = 320;
		break;
	case GCORE_GC1054_MIPI_1M_30FPS_10BIT:
	case GCORE_GC4683_MIPI_1M_120FPS_10BIT:
	...
	case TECHPOINT_TP2825_MIPI_1M_30FPS_8BIT:
	...
	case GCORE_GC2145_2M_12FPS_8BIT:
		sns_cfg->u32ImageWigth[dev_num] = 1600;
		sns_cfg->u32ImageHeight[dev_num] = 1200;
		break;
	case SMS_SC202CS_MIPI_600P_30FPS_10BIT:
		sns_cfg->u32ImageWigth[dev_num] = 800;
		sns_cfg->u32ImageHeight[dev_num] = 600;
		break;
	case BRIGATES_BG0808_MIPI_2M_30FPS_10BIT:
	case BRIGATES_BG0808_MIPI_2M_30FPS_10BIT_WDR2TO1:
	case OV_OS04A10_MIPI_2M_1080P_30FPS_2L_10BIT:
	case OV_OS04A10_MIPI_2M_1080P_60FPS_2L_10BIT:
	case OV_OS04A10_MIPI_2M_1080P_30FPS_10BIT_WDR2TO1:
	...
	case SMS_SC233HGS_MIPI_2M_120FPS_10BIT:
	case SMS_SC233HGS_MIPI_2M_60FPS_10BIT_WDR2TO1:
	case SMS_SC235HAI_1L_MIPI_2M_15FPS_10BIT:
	case SMS_SC235HAI_1L_SLAVE_MIPI_2M_15FPS_10BIT:
	case SMS_SC235HAI_2L_MIPI_2M_30FPS_10BIT:
	case SMS_SC235HAI_2L_MIPI_2M_15FPS_10BIT:
	...
	case SOI_F23_MIPI_2M_30FPS_10BIT_WDR2TO1:
	...
	case SONY_IMX662_MIPI_2M_30FPS_10BIT:
	case SONY_IMX662_MIPI_2M_30FPS_10BIT_WDR2TO1:
	case TECHPOINT_TP2825_MIPI_2M_30FPS_8BIT:
	case TECHPOINT_TP2825_MIPI_2M_50FPS_8BIT:
	case TECHPOINT_TP2825_MIPI_2M_60FPS_8BIT:
	...
	case GCORE_GC4683_MIPI_4M_60FPS_10BIT:
	...
	case SMS_SC431HAI_2L_MIPI_4M_30FPS_10BIT:
	case SMS_SC431HAI_1L_MIPI_4M_20FPS_10BIT:
	...
	case SONY_IMX415_MIPI_4M_25FPS_12BIT_WDR2TO1:
	case SONY_IMX675_MIPI_4M_30FPS_12BIT:
	...
	case IMGDS_MIS40C1_MIPI_4M_20FPS_1L_10BIT:
	case IMGDS_MIS40H1_MIPI_4M_25FPS_2L_10BIT:
	case TECHPOINT_TP2825_MIPI_4M_25FPS_8BIT:
	case TECHPOINT_TP2825_MIPI_4M_30FPS_8BIT:
	...
	case SMS_SC1346_1L_MIPI_600P_60FPS_10BIT:
	case SMS_SC1336_1L_MIPI_600P_30FPS_10BIT:
	case SMS_SC1336_1L_MIPI_600P_60FPS_10BIT:
		sns_cfg->u32ImageWigth[dev_num] = 1024;
		sns_cfg->u32ImageHeight[dev_num] = 600;
		break;
	...
	case SMS_SC535HAI_MIPI_5M_30FPS_4L_10BIT_MASTER:
	case SMS_SC535HAI_MIPI_5M_30FPS_4L_10BIT_SLAVE:
	case SMS_SC535HAI_MIPI_5M_30FPS_2L_10BIT_MASTER:
	case SMS_SC535HAI_MIPI_5M_30FPS_2L_10BIT_SLAVE:
	case SMS_SC535HAI_MIPI_5M_15FPS_4L_10BIT_MASTER:
	case SMS_SC535HAI_MIPI_5M_15FPS_4L_10BIT_SLAVE:
	case SMS_SC535HAI_MIPI_5M_15FPS_2L_10BIT_MASTER:
	case SMS_SC535HAI_MIPI_5M_15FPS_2L_10BIT_SLAVE:
		sns_cfg->u32ImageWigth[dev_num] = 2560;
		sns_cfg->u32ImageHeight[dev_num] = 1920;
		break;
	case SONY_IMX675_MIPI_5M_30FPS_12BIT:
	case SONY_IMX675_MIPI_5M_25FPS_12BIT_WDR2TO1:
	case SONY_IMX678_MIPI_5M_25FPS_12BIT_WDR2TO1:
		sns_cfg->u32ImageWigth[dev_num] = 2560;
	...
	case SMS_SC533HAI_MIPI_5M_30FPS_10BIT:
	case SMS_SC533HAI_MIPI_5M_30FPS_10BIT_WDR2TO1:
	case SMS_SC533HAI_2L_MIPI_5M_30FPS_10BIT:
	...
	case OV_OV48B2Q_PDAF_MIPI_8M_30FPS_10BIT:
	case SMS_SC831HAI_MASTER_MIPI_8M_30FPS_10BIT:
	case SMS_SC831HAI_SLAVE_MIPI_8M_30FPS_10BIT:
	...
	case SONY_IMX135_MIPI_8M_25FPS_10BIT:
	...
	case SMS_SC635AI_MIPI_6M_60FPS_10BIT:
		...
		break;
	case OV_OV48B2Q_PDAF_MIPI_12M_30FPS_10BIT:
		sns_cfg->u32ImageWigth[dev_num] = 4000;
	...
	case SONY_IMX412_MIPI_8M_30FPS_12BIT_WDR2TO1:
		...
		break;
	case GCORE_GC0308_1M_30FPS_8BIT:
...
CVI_S32 cvi_sns_getsnsobj(CVI_U32 dev_num, SENSOR_CFG_S *sensor_cfg)
{
	...
	case CVSENS_CV2003_1L_SLAVE_LOW_MIPI_2M_1080P_30FPS_10BIT:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_CVSENS_CV2005)
	case CVSENS_CV2005_1L_MIPI_2M_1080P_15FPS_10BIT:
		pSnsObj = &stSnsCV2005_Obj;
		break;
#endif
	...
	case GCORE_GC02M1_MIPI_2M_30FPS_10BIT:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_GCORE_GC0308)
	case GCORE_GC0308_1M_30FPS_8BIT:
		pSnsObj = &stSnsGc0308_Obj;
		break;
#endif
	...
	case GCORE_GC2053_1L_MIPI_2M_30FPS_10BIT:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_GCORE_GC2083)
	case GCORE_GC2083_2L_MIPI_2M_30FPS_10BIT:
		pSnsObj = &stSnsGc2083_Obj;
		break;
#endif
	...
	case GCORE_GC4653_MIPI_4M_30FPS_10BIT:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_GCORE_GC4683)
	case GCORE_GC4683_MIPI_4M_60FPS_10BIT:
	case GCORE_GC4683_MIPI_2M_60FPS_10BIT:
	case GCORE_GC4683_MIPI_1M_120FPS_10BIT:
		pSnsObj = &stSnsGc4683_Obj;
		break;
#endif
	...
	case GCORE_GC8613_MIPI_8M_60FPS_10BIT:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_IMGDS_MIS40C1)
	case IMGDS_MIS40C1_MIPI_4M_20FPS_1L_10BIT:
	case IMGDS_MIS40C1_MIPI_4M_20FPS_2L_10BIT:
		pSnsObj = &stSnsMIS40C1_Obj;
		break;
#endif
#if defined(CONFIG_SENSOR_IMGDS_MIS40H1)
	case IMGDS_MIS40H1_MIPI_4M_25FPS_2L_10BIT:
		pSnsObj = &stSnsMIS40H1_Obj;
		break;
#endif
	...
	case ONSEMI_AR2020_20M_25FPS_10BIT:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_OV_OS02G10)
	case OV_OS02G10_MIPI_2M_30FPS_10BIT:
		pSnsObj = &stSnsOs02g10_Obj;
		break;
#endif
	...
	case OV_OV4689_MIPI_4M_30FPS_10BIT:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_OV_OV48B2Q)
	case OV_OV48B2Q_PDAF_MIPI_8M_30FPS_10BIT:
	case OV_OV48B2Q_PDAF_MIPI_12M_30FPS_10BIT:
		pSnsObj = &stSnsOv48b2q_Obj;
		break;
#endif
	...
	case SMS_SC233HGS_MIPI_2M_60FPS_10BIT_WDR2TO1:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_SMS_SC235HAI)
	case SMS_SC235HAI_1L_MIPI_2M_15FPS_10BIT:
	case SMS_SC235HAI_2L_MIPI_2M_15FPS_10BIT:
	case SMS_SC235HAI_2L_MIPI_2M_30FPS_10BIT:
	case SMS_SC235HAI_1L_SLAVE_MIPI_2M_15FPS_10BIT:
	case SMS_SC235HAI_2L_SLAVE_MIPI_2M_15FPS_10BIT:
		pSnsObj = &stSnsSC235HAI_Obj;
		break;
#endif
	...
	case SMS_SC401AI_MIPI_3M_30FPS_10BIT:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_SMS_SC431HAI)
	case SMS_SC431HAI_2L_MIPI_4M_30FPS_10BIT:
	case SMS_SC431HAI_1L_MIPI_4M_20FPS_10BIT:
		pSnsObj = &stSnsSC431HAI_Obj;
		break;
#endif
	...
	case SMS_SC531AI_2L_MIPI_5M_30FPS_10BIT:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_SMS_SC533HAI)
	case SMS_SC533HAI_MIPI_5M_30FPS_10BIT:
	case SMS_SC533HAI_MIPI_5M_30FPS_10BIT_WDR2TO1:
	case SMS_SC533HAI_2L_MIPI_5M_30FPS_10BIT:
		pSnsObj = &stSnsSC533HAI_Obj;
		break;
#endif
#if defined(SENSOR_SMS_SC535HAI)
	case SMS_SC535HAI_MIPI_5M_30FPS_4L_10BIT_MASTER:
	case SMS_SC535HAI_MIPI_5M_30FPS_4L_10BIT_SLAVE:
	case SMS_SC535HAI_MIPI_5M_30FPS_2L_10BIT_MASTER:
	case SMS_SC535HAI_MIPI_5M_30FPS_2L_10BIT_SLAVE:
	...
	case SMS_SC635AI_MIPI_6M_60FPS_10BIT:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_SMS_SC831HAI)
    case SMS_SC831HAI_MASTER_MIPI_8M_30FPS_10BIT:
    case SMS_SC831HAI_SLAVE_MIPI_8M_30FPS_10BIT:
        pSnsObj = &stSnsSC831HAI_Obj;
        break;
#endif
	...
	case SMS_SC1330_1L_MIPI_1M_30FPS_12BIT_SLAVE:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_SMS_SC1336_1L)
       case SMS_SC1336_1L_MIPI_1M_30FPS_10BIT:
       case SMS_SC1336_1L_MIPI_1M_60FPS_10BIT:
       case SMS_SC1336_1L_MIPI_600P_30FPS_10BIT:
       case SMS_SC1336_1L_MIPI_600P_60FPS_10BIT:
               ...
               break;
#endif
#if defined(CONFIG_SENSOR_SMS_SC1346_1L)
       case SMS_SC1346_1L_MIPI_1M_30FPS_10BIT:
       case SMS_SC1346_1L_MIPI_1M_60FPS_10BIT:
       case SMS_SC1346_1L_MIPI_600P_30FPS_10BIT:
       case SMS_SC1346_1L_MIPI_600P_60FPS_10BIT:
               ...
               break;
#endif
#if defined(CONFIG_SENSOR_SMS_SC1346_1L_SLAVE)
       case SMS_SC1346_1L_SLAVE_MIPI_1M_30FPS_10BIT:
       case SMS_SC1346_1L_SLAVE_MIPI_1M_60FPS_10BIT:
	...
	case SMS_SC4336P_SLAVE_MIPI_4M_30FPS_10BIT:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_SMS_SC202L)
	case SMS_SC202L_2L_MASTER_MIPI_2M_30FPS_10BIT:
	case SMS_SC202L_2L_SLAVE_MIPI_2M_30FPS_10BIT:
		pSnsObj = &stSnsSC202L_Obj;
		break;
#endif
#if defined(CONFIG_SENSOR_SMS_SC202CS)
	case SMS_SC202CS_MIPI_600P_30FPS_10BIT:
	case SMS_SC202CS_1L_SLAVE_MIPI_320P_30FPS_10BIT:
	case SMS_SC202CS_1L_MASTER_MIPI_320P_30FPS_10BIT:
		pSnsObj = &stSnsSC202CS_Obj;
		break;
#endif
	...
	case SOI_Q03_MIPI_3M_30FPS_10BIT:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_SONY_IMX135)
	case SONY_IMX135_MIPI_8M_25FPS_10BIT:
		pSnsObj = &stSnsImx135_Obj;
		break;
#endif
	...
	case SONY_IMX585_MIPI_8M_25FPS_12BIT_WDR2TO1:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_SONY_IMX662)
	case SONY_IMX662_MIPI_2M_30FPS_10BIT:
	case SONY_IMX662_MIPI_2M_30FPS_10BIT_WDR2TO1:
		pSnsObj = &stSnsImx662_Obj;
		break;
#endif
	...
	case SONY_IMX900_MIPI_3M_70FPS_12BIT_MONO:
		...
		break;
#endif
#if defined(CONFIG_SENSOR_TECHPOINT_TP2825)
	case TECHPOINT_TP2825_MIPI_4M_25FPS_8BIT:
	case TECHPOINT_TP2825_MIPI_4M_30FPS_8BIT:
	case TECHPOINT_TP2825_MIPI_1M_30FPS_8BIT:
	case TECHPOINT_TP2825_MIPI_2M_30FPS_8BIT:
