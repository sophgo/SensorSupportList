...
# 添加项目名称
# 【参考格式】 \Huge \textbf{CV180x 芯片码率控制使用说明} \par
# 添加版本号
...
latex_elements = {
    # Papersize ('letterpaper' or 'a4paper' or 'a3paper'), default is letterpaper
    # 整个文档使用A4横向
    'papersize': 'a4paper',
    # 设置横向页面布局和页边距大小
    'geometry': r'\usepackage[landscape,left=1cm,right=1cm,top=1.5cm,bottom=1.5cm]{geometry}',
    # The font size ('10pt', '11pt' or '12pt'), default is '10pt'. 使用较小字体以容纳更多内容
    'pointsize': '8pt',
    ...
    % 设置表格使用更小的字体和更紧凑的间距，确保所有列能在一行显示
    ...
    \let\longtable\relax
    \usepackage{longtable}
    \let\longtable\oldlongtable
    \fancypagestyle{normal}{
        \fancyhead[L]{\includegraphics[width=3cm,height=1cm]{header_logo.png}\quad CVITEK Sensor支持列表}
