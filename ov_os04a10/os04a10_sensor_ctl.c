...
static void os04a10_wdr_1080p30_2to1_init(VI_PIPE ViPipe);
static void os04a10_linear_1520p30_12BIT_init(VI_PIPE ViPipe);
static void os04a10_linear_2L_10BIT_base_init(VI_PIPE ViPipe);
static void os04a10_linear_1520p30_10BIT_2L_init(VI_PIPE ViPipe);
static void os04a10_linear_1080p30_10BIT_2L_init(VI_PIPE ViPipe);
static void os04a10_linear_1080p60_10BIT_2L_init(VI_PIPE ViPipe);
...
void os04a10_init(VI_PIPE ViPipe)
{
	...
	if (enWDRMode == WDR_MODE_2To1_LINE) {
		...
		} else if (u8ImgMode == OS04A10_MODE_1080P30_WDR) {
			os04a10_wdr_1080p30_2to1_init(ViPipe);
		...
		} else if (u8ImgMode == OS04A10_MODE_1080P30_2L_10BIT) {
			os04a10_linear_1080p30_10BIT_2L_init(ViPipe);
		} else if (u8ImgMode == OS04A10_MODE_1080P60_2L_10BIT) {
			os04a10_linear_1080p60_10BIT_2L_init(ViPipe);
...
static void os04a10_linear_1520p30_10BIT_2L_init(VI_PIPE ViPipe)
{
	os04a10_linear_2L_10BIT_base_init(ViPipe);
	os04a10_default_reg_init(ViPipe);
	os04a10_write_register(ViPipe, 0x0100, 0x01);
	usleep(200 * 1000);
...
static void os04a10_linear_1080p30_10BIT_2L_init(VI_PIPE ViPipe)
{
	...
	os04a10_write_register(ViPipe, 0x3800, 0x01);
	os04a10_write_register(ViPipe, 0x3801, 0x40);
	os04a10_write_register(ViPipe, 0x3802, 0x00);
	os04a10_write_register(ViPipe, 0x3803, 0xb4);
	os04a10_write_register(ViPipe, 0x3804, 0x09);
	os04a10_write_register(ViPipe, 0x3805, 0x4f);
	os04a10_write_register(ViPipe, 0x3806, 0x05);
	os04a10_write_register(ViPipe, 0x3807, 0x4b);
	os04a10_write_register(ViPipe, 0x3808, 0x07);
	os04a10_write_register(ViPipe, 0x3809, 0x80);
	os04a10_write_register(ViPipe, 0x380a, 0x04);
	os04a10_write_register(ViPipe, 0x380b, 0x38);
	os04a10_write_register(ViPipe, 0x380c, 0x04);
	os04a10_write_register(ViPipe, 0x380d, 0x58);
	os04a10_write_register(ViPipe, 0x380e, 0x08);
	os04a10_write_register(ViPipe, 0x380f, 0xca);
	os04a10_write_register(ViPipe, 0x3810, 0x00);
	os04a10_write_register(ViPipe, 0x3811, 0x08);
	os04a10_write_register(ViPipe, 0x3812, 0x00);
	os04a10_write_register(ViPipe, 0x3813, 0x08);
	os04a10_write_register(ViPipe, 0x384c, 0x02);
	os04a10_write_register(ViPipe, 0x384d, 0xdc);
	...
	printf("ViPipe:%d,===OS04A10 1080P 30fps 10bit 2L LINE Init OK!===\n", ViPipe);
}
...
static void os04a10_linear_1080p60_10BIT_2L_init(VI_PIPE ViPipe)
{
	...
	os04a10_write_register(ViPipe, 0x380c, 0x04);
	os04a10_write_register(ViPipe, 0x380d, 0x58);
	os04a10_write_register(ViPipe, 0x380e, 0x04);
	os04a10_write_register(ViPipe, 0x380f, 0x65);
	os04a10_write_register(ViPipe, 0x3810, 0x00);
	os04a10_write_register(ViPipe, 0x3811, 0x08);
	os04a10_write_register(ViPipe, 0x3812, 0x00);
	os04a10_write_register(ViPipe, 0x3813, 0x08);
	...
	printf("ViPipe:%d,===OS04A10 1080P 60fps 10bit 2L LINE Init OK!===\n", ViPipe);
}
...
static void os04a10_wdr_1080p30_2to1_init(VI_PIPE ViPipe)
{
	...
	os04a10_write_register(ViPipe, 0x0104, 0x02);
	os04a10_write_register(ViPipe, 0x0102, 0x00);
	os04a10_write_register(ViPipe, 0x0305, 0x50);
	os04a10_write_register(ViPipe, 0x0306, 0x00);
	os04a10_write_register(ViPipe, 0x0307, 0x00);
	os04a10_write_register(ViPipe, 0x0308, 0x04);
	os04a10_write_register(ViPipe, 0x030a, 0x01);
	...
	os04a10_write_register(ViPipe, 0x0323, 0x02);
	os04a10_write_register(ViPipe, 0x0324, 0x00);
	os04a10_write_register(ViPipe, 0x0325, 0xf0);
	os04a10_write_register(ViPipe, 0x0327, 0x07);
	os04a10_write_register(ViPipe, 0x0328, 0x05);
	os04a10_write_register(ViPipe, 0x0329, 0x05);
	os04a10_write_register(ViPipe, 0x032a, 0x02);
	os04a10_write_register(ViPipe, 0x032c, 0x02);
	os04a10_write_register(ViPipe, 0x032d, 0x02);
	os04a10_write_register(ViPipe, 0x032e, 0x02);
	os04a10_write_register(ViPipe, 0x032f, 0x00);
	os04a10_write_register(ViPipe, 0x300f, 0x11);
	os04a10_write_register(ViPipe, 0x3012, 0x21);
	os04a10_write_register(ViPipe, 0x3026, 0x10);
	os04a10_write_register(ViPipe, 0x3027, 0x08);
	...
	os04a10_write_register(ViPipe, 0x380b, 0x38);
	os04a10_write_register(ViPipe, 0x380c, 0x05);
	os04a10_write_register(ViPipe, 0x380d, 0x49);
	os04a10_write_register(ViPipe, 0x380e, 0x06);
	os04a10_write_register(ViPipe, 0x380f, 0x00);
	os04a10_write_register(ViPipe, 0x3810, 0x01);
	os04a10_write_register(ViPipe, 0x3811, 0x70);
	os04a10_write_register(ViPipe, 0x3813, 0xfc);
	os04a10_write_register(ViPipe, 0x3814, 0x01);
	os04a10_write_register(ViPipe, 0x3815, 0x01);
	os04a10_write_register(ViPipe, 0x3816, 0x01);
	os04a10_write_register(ViPipe, 0x3817, 0x01);
	...
	os04a10_write_register(ViPipe, 0x3833, 0x41);
	os04a10_write_register(ViPipe, 0x384c, 0x05);
	os04a10_write_register(ViPipe, 0x384d, 0x49);
	os04a10_write_register(ViPipe, 0x3858, 0x3c);
	os04a10_write_register(ViPipe, 0x3865, 0x02);
	os04a10_write_register(ViPipe, 0x3866, 0x00);
	os04a10_write_register(ViPipe, 0x3867, 0x00);
	...
	os04a10_write_register(ViPipe, 0x4813, 0x84);
	os04a10_write_register(ViPipe, 0x481f, 0x30);
	os04a10_write_register(ViPipe, 0x4837, 0x0b);
	os04a10_write_register(ViPipe, 0x484b, 0x67);
	os04a10_write_register(ViPipe, 0x4d00, 0x4d);
	os04a10_write_register(ViPipe, 0x4d01, 0x9d);
	os04a10_write_register(ViPipe, 0x4d02, 0xb9);
	...
	printf("ViPipe:%d,===OS04A10 1080P 30fps 10bit 2to1 WDR Init OK!===\n", ViPipe);
}
