...
ISP_SNS_STATE_S *g_pastSC233HGS[VI_MAX_PIPE_NUM] = {CVI_NULL};
SNS_COMBO_DEV_ATTR_S* g_pastSC233HGSComboDevArray[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define SC233HGS_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastSC233HGS[dev])
#define SC233HGS_SENSOR_SET_CTX(dev, pstCtx)   (g_pastSC233HGS[dev] = pstCtx)
#define SC233HGS_SENSOR_RESET_CTX(dev)         (g_pastSC233HGS[dev] = CVI_NULL)
#define SC233HGS_SENSOR_GET_COMBO(dev, pstCtx)   (pstCtx = g_pastSC233HGSComboDevArray[dev])
#define SC233HGS_SENSOR_SET_COMBO(dev, pstCtx)   (g_pastSC233HGSComboDevArray[dev] = pstCtx)

ISP_SNS_COMMBUS_U g_aunSC233HGS_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};
ISP_SNS_COMMADDR_U g_aunSC233HGS_AddrInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cAddr = 0},
...
SC233HGS_STATE_S g_astSC233HGS_State[VI_MAX_PIPE_NUM] = {{0} };
...
/*****SC233HGS Lines Range*****/
#define SC233HGS_FULL_LINES_MAX          (0x7F00)
#define SC233HGS_FULL_LINES_MAX_2TO1_WDR (0x7F00)
/*****SC233HGS Register Address*****/
#define SC233HGS_SHS1_0_ADDR		0x3E00
...
#define SC233HGS_DGAIN1_ADDR		0x3E06
#define SC233HGS_DGAIN2_ADDR		0x3E07

#define SC233HGS_VMAX_ADDR			0x320E
// #define SC233HGS_MAXSEXP_ADDR
...
static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	pstMode = &g_astSC233HGS_mode[pstSnsState->u8ImgMode];
#if 0
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Vts = g_astSC233HGS_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astSC233HGS_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astSC233HGS_mode[pstSnsState->u8ImgMode].f32MinFps;
	...
	case SC233HGS_MODE_1080P120:
		...
		u32VMAX = (u32VMAX > SC233HGS_FULL_LINES_MAX) ? SC233HGS_FULL_LINES_MAX : u32VMAX;
		break;
	default:
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		g_astSC233HGS_State[ViPipe].u32Sexp_MAX = u16MaxSexpReg - 5;
	}
...
static CVI_S32 cmos_inttime_update(VI_PIPE ViPipe, CVI_U32 *u32IntTime)
{
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		 ...
		 * step : 4
		 */
		pstSnsState->au32WDRIntTime[0] = (u32ShortIntTime > g_astSC233HGS_State[ViPipe].u32Sexp_MAX) ?
			g_astSC233HGS_State[ViPipe].u32Sexp_MAX : u32ShortIntTime;
		 ...
		 * step : 4
		 */
		u32MaxLExp = pstSnsState->au32FL[0] - g_astSC233HGS_State[ViPipe].u32Sexp_MAX;
...
static CVI_S32 cmos_gains_update(VI_PIPE ViPipe, CVI_U32 *pu32Again, CVI_U32 *pu32Dgain)
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	ISP_SNS_REGS_INFO_S *pstSnsRegsInfo = CVI_NULL;
	CVI_U32 u16Mode = g_au16SC233HGS_GainMode[ViPipe];
	CVI_U32 u32Again;
	CVI_U32 u32Dgain;
		...
		CVI_U32 *au32IntTimeMax, CVI_U32 *au32IntTimeMin, CVI_U32 *pu32LFMaxIntTime)
{
	...
	u32IntTimeMaxTmp = (u32IntTimeMaxTmp > (g_astSC233HGS_State[ViPipe].u32Sexp_MAX * 2)) ?
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const SC233HGS_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunSC233HGS_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = g_aunSC233HGS_AddrInfo[ViPipe].s8I2cAddr;
			pstI2c_data[i].u32AddrByteNum = sc233hgs_addr_byte;
			pstI2c_data[i].u32DataByteNum = sc233hgs_data_byte;
		}
		...
		case WDR_MODE_2To1_LINE:
			...
			pstI2c_data[WDR2_SHS1_1_ADDR].u32RegAddr = SC233HGS_SHS1_1_ADDR;
			pstI2c_data[WDR2_SHS1_2_ADDR].u32RegAddr = SC233HGS_SHS1_2_ADDR;
			pstI2c_data[WDR2_SHS2_0_ADDR].u32RegAddr = SC233HGS_SHS2_0_ADDR;
			pstI2c_data[WDR2_SHS2_1_ADDR].u32RegAddr = SC233HGS_SHS2_1_ADDR;
			pstI2c_data[WDR2_SHS2_2_ADDR].u32RegAddr = SC233HGS_SHS2_2_ADDR;
			pstI2c_data[WDR2_AGAIN1_0_ADDR].u32RegAddr = SC233HGS_AGAIN1_ADDR;
			pstI2c_data[WDR2_AGAIN1_1_ADDR].u32RegAddr = SC233HGS_AGAIN1_ADDR + 1;
			pstI2c_data[WDR2_DGAIN1_0_ADDR].u32RegAddr = SC233HGS_DGAIN1_ADDR;
			pstI2c_data[WDR2_DGAIN1_1_ADDR].u32RegAddr = SC233HGS_DGAIN1_ADDR + 1;
			pstI2c_data[WDR2_AGAIN2_0_ADDR].u32RegAddr = SC233HGS_AGAIN2_ADDR;
			pstI2c_data[WDR2_AGAIN2_1_ADDR].u32RegAddr = SC233HGS_AGAIN2_ADDR + 1;
			pstI2c_data[WDR2_DGAIN2_0_ADDR].u32RegAddr = SC233HGS_DGAIN2_ADDR;
		...
		default:
			...
			pstI2c_data[LINEAR_SHS1_1_ADDR].u32RegAddr = SC233HGS_SHS1_1_ADDR;
			pstI2c_data[LINEAR_SHS1_2_ADDR].u32RegAddr = SC233HGS_SHS1_2_ADDR;
			pstI2c_data[LINEAR_AGAIN_0_ADDR].u32RegAddr = SC233HGS_AGAIN1_ADDR;
			pstI2c_data[LINEAR_AGAIN_1_ADDR].u32RegAddr = SC233HGS_AGAIN1_ADDR + 1;
			pstI2c_data[LINEAR_DGAIN_0_ADDR].u32RegAddr = SC233HGS_DGAIN1_ADDR;
			pstI2c_data[LINEAR_DGAIN_1_ADDR].u32RegAddr = SC233HGS_DGAIN1_ADDR + 1;
			pstI2c_data[LINEAR_VMAX_0_ADDR].u32RegAddr = SC233HGS_VMAX_ADDR;
			pstI2c_data[LINEAR_VMAX_1_ADDR].u32RegAddr = SC233HGS_VMAX_ADDR + 1;
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	SC233HGS_SENSOR_GET_CTX(ViPipe, pstSnsState);
	SC233HGS_SENSOR_GET_COMBO(ViPipe,pstRxAttrSrc);
	...
	pstRxAttr->img_size.start_x = g_astSC233HGS_mode[pstSnsState->u8ImgMode].astImg[0].stWndRect.s32X;
	pstRxAttr->img_size.start_y = g_astSC233HGS_mode[pstSnsState->u8ImgMode].astImg[0].stWndRect.s32Y;
	pstRxAttr->img_size.active_w = g_astSC233HGS_mode[pstSnsState->u8ImgMode].astImg[0].stWndRect.u32Width;
	pstRxAttr->img_size.active_h = g_astSC233HGS_mode[pstSnsState->u8ImgMode].astImg[0].stWndRect.u32Height;
	pstRxAttr->img_size.width = g_astSC233HGS_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astSC233HGS_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	pstRxAttr->img_size.max_width = g_astSC233HGS_mode[pstSnsState->u8ImgMode].astImg[0].stMaxSize.u32Width;
	pstRxAttr->img_size.max_height = g_astSC233HGS_mode[pstSnsState->u8ImgMode].astImg[0].stMaxSize.u32Height;
...
static CVI_S32 sensor_patch_rx_attr(VI_PIPE ViPipe, RX_INIT_ATTR_S *pstRxInitAttr)
{
	...
	if(!g_pastSC233HGSComboDevArray[ViPipe]) {
		pstRxAttr = malloc(sizeof(SNS_COMBO_DEV_ATTR_S));
	} else {
		SC233HGS_SENSOR_GET_COMBO(ViPipe, pstRxAttr);
	}
	memcpy(pstRxAttr, &sc233hgs_rx_attr, sizeof(SNS_COMBO_DEV_ATTR_S));
	SC233HGS_SENSOR_SET_COMBO(ViPipe, pstRxAttr);
...
void sc233hgs_exit(VI_PIPE ViPipe)
{
	if(g_pastSC233HGSComboDevArray[ViPipe]) {
		free(g_pastSC233HGSComboDevArray[ViPipe]);
		g_pastSC233HGSComboDevArray[ViPipe] = CVI_NULL;
	}
	sc233hgs_i2c_exit(ViPipe);
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = sc233hgs_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = sc233hgs_exit;
...
{
	if (SC233HGS_I2C_ADDR_IS_VALID(s32I2cAddr))
...
static CVI_S32 sc233hgs_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunSC233HGS_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	SC233HGS_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = SC233HGS_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, SC233HGS_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, SC233HGS_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, SC233HGS_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16SC233HGS_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16SC233HGS_L2SMode[ViPipe] = pstInitAttr->enL2SMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsSC233HGS_Obj = {
