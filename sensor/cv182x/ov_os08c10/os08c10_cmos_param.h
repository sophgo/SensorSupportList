#ifndef __OS08C10_CMOS_PARAM_H_
#define __OS08C10_CMOS_PARAM_H_
...
static const OS08C10_MODE_S g_astOs08c10_mode[OS08C10_MODE_NUM] = {
	[OS08C10_MODE_1920X1080P60_WDR] = {
		.name = "1920x1080p60wdr",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 1920,
				.u32Height = 1080,
		...
		.f32MaxFps = 60,
		.f32MinFps = 1.62, /* 0x4a6 * 60 / 0xFFFF */
		.u32HtsDef = 0x041a,
		.u32VtsDef = 0x04a6,
		.stExp[0] = {
			.u16Min = 8,
	...
	[OS08C10_MODE_1280X720P120_WDR] = {
		...
		.f32MaxFps = 120,
		.f32MinFps = 1.83, /* 0x04a6 * 120 / 0xFFFF */
		.u32HtsDef = 0x041a,
		.u32VtsDef = 0x0341,
		.stExp[0] = {
			.u16Min = 8,
...
struct combo_dev_attr_s os08c10_rx_attr = {
