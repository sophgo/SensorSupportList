#ifndef __GC2093_SLAVE_CMOS_PARAM_H_
#define __GC2093_SLAVE_CMOS_PARAM_H_
...
static const GC2093_SLAVE_MODE_S g_astGc2093_Slave_mode[GC2093_SLAVE_MODE_NUM] = {
	[GC2093_SLAVE_MODE_1920X1080P30] = {
		.name = "1920X1080P30",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 1920,
	...
	[GC2093_SLAVE_MODE_1920X1080P30_WDR] = {
...
struct combo_dev_attr_s gc2093_slave_rx_attr = {
...
#endif /* __GC2093_SLAVE_CMOS_PARAM_H_ */
